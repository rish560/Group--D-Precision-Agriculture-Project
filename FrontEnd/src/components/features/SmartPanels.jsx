...
export const SmartPanels = ({ weather, notifications, farms }) => {
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-3">
      <Card className="border-emerald-100 dark:border-emerald-500/30 bg-gradient-to-br from-emerald-600 to-green-600 p-4 text-white">
      ...
      <Card className="border-slate-200 dark:border-slate-700 lg:col-span-3">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-3">
          <div className="rounded-2xl border border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 p-3">
            <div className="flex items-center gap-2 text-slate-700 dark:text-gray-300"><MapPin className="h-4 w-4 text-emerald-700" />{t('maps')}</div>
            <p className="mt-2 text-sm text-slate-500 dark:text-gray-400">Geo-tagged farms and route-based field planning.</p>
          </div>
          <div className="rounded-2xl border border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 p-3">
            <div className="flex items-center gap-2 text-slate-700 dark:text-gray-300"><Waves className="h-4 w-4 text-emerald-700" />{t('soil')}</div>
            <p className="mt-2 text-sm text-slate-500 dark:text-gray-400">Soil analysis and irrigation guidance from sensor or image input.</p>
          </div>
          <div className="rounded-2xl border border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 p-3">
            <div className="flex items-center gap-2 text-slate-700 dark:text-gray-300"><Leaf className="h-4 w-4 text-emerald-700" />{t('disease')}</div>
            <p className="mt-2 text-sm text-slate-500 dark:text-gray-400">Image-based disease detection with treatment guidance.</p>
          </div>
        </div>
      </Card>
    </div>
