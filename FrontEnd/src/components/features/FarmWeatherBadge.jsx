...
export const FarmWeatherBadge = ({ location }) => {
  ...
  return (
    <div className="mt-2 flex items-center justify-between gap-3 rounded-xl bg-sky-50 dark:bg-slate-800 px-3 py-2 border border-sky-100 dark:border-slate-700">
      {/* Current */}
