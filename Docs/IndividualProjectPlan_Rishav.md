...
```mermaid
flowchart TD
    A["Frontend\nReact.js / HTML5 / CSS3\nUser Dashboards"] -->|REST API / JSON Data| B["Backend\nSpring Boot MVC / Spring Data JPA\nJava"]
    B -->|JDBC Connections| C[("Database\nMySQL Relational Database")]

    classDef front fill:#1f4e79,stroke:#12304a,color:#ffffff
    classDef back fill:#2f6f4f,stroke:#1b4332,color:#ffffff
    classDef data fill:#7a5c2e,stroke:#4f3b1d,color:#ffffff
